                ...
                if (id) {
                    ...
                    if (payment) {
                        ...
                        if (payment.paidToContact) {
                            if (custs.some((c: any) => c.name === payment.paidToContact)) {
                                setPaidByContact('Customer');
                            } else if (supps.some((s: any) => s.name === payment.paidToContact)) {
                                setPaidByContact('Supplier');
                            } else {
                                setPaidByContact('Other');
                            }
                            setPaidByOptional(payment.paidToContact);
                        } else {
                            setPaidByContact('Customer');
                            setPaidByOptional('');
                        }
                        ...
                        if (payment.items) {
                            setItems(payment.items.map((it: any) => {
                                let accName = it.account || 'Suspense';
