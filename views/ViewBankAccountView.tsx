            ...
            <div className="flex-1 p-6 flex justify-center overflow-auto bg-[#f3f4f6]">
                <div className="bg-white shadow-xl p-12 w-full max-w-[950px] min-h-[600px] relative font-sans text-gray-900 border border-gray-200">
                    ...
                    <div className="border-t border-gray-200 pt-8 mt-8">
                        <span className="font-bold block text-gray-400 uppercase text-[10px] mb-4">Bank Ledger</span>
                        {entries.length === 0 ? (
                            <p className="text-gray-500 text-sm">No movements yet. Receipts, payments, and transfers will appear here.</p>
                        ) : (
